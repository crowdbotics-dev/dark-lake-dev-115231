"""
Django settings for dark_lake_dev_115231 project.
...
ROOT_URLCONF = 'dark_lake_dev_115231.urls'
...
WSGI_APPLICATION = 'dark_lake_dev_115231.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_lake_dev_115231 API",
    "DESCRIPTION": "API documentation for dark_lake_dev_115231 App",
    "VERSION": "v1",
}
