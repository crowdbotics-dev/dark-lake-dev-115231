...
## Project Structure
    ...
    ├── dark_lake_dev_115231  # Django project configurations
...
1. Clone this repo and `cd dark_lake_dev_115231`
...
2. Clone this repo and `cd dark_lake_dev_115231`
